...
class YumAdminMenu extends CPortlet {
	...
	public function getMenuItems() {
		return array( 
				...
				array('label' => 'Report',
					'visible' => Yum::hasModule('report')
					,'items' => array(
						array('label' => 'Projects', 'url' => array('/report/project/index')),
						array('label' => 'Tasks', 'url' => array('/report/task/index')),
						array('label' => 'Reports', 'url' => array('/report/report/index')),
						)
					),
