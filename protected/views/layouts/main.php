...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/yum.css" />
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'My account', 'url'=>array('/user/user/'), 'visible'=>!Yii::app()->user->isGuest),
